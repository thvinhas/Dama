 ...
 * @author THIAGO
 */
public class ChatServidor extends JFrame implements ActionListener, KeyListener, Runnable {
...
public ChatServidor(JTextField Ip, JTextField Porta) throws IOException{
    s = DamaServidor.s;
    ss =DamaServidor.ss;
    din = DamaServidor.din;
    dout = DamaServidor.dout;
    txtIP = Ip;
    txtPorta = Porta;
    txtNome = "Servidor";                     
     ...
     while(!msgin.equals("exit")){
            if(yy == 0){
                ...
                texto.setText(texto.getText().trim()+aa+"Cliente: "+msgin);
                    ...
                    yy = 0;
                    DamaServidor.ReceberMensagem(msgin);
                }
            }
